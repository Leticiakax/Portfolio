...
const Data = () => {
    return (
        <div className="home__data">
            <h1 className="home__title">Letícia K.
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
            ...
            <p className="home__description">Hey! You can call me Lee, I'm 22 years old and currently a university student of systems analysis and development with completion scheduled for July/2025 and looking for an internship opportunity in the technology area.</p>
